...
import { AddLabPasien } from './screens/AddLabPasien';
				...
				<div className="App">
					<nav className="navbar navbar-expand-sm navbar-dark bg-dark">
						...
						<div className="collapse navbar-collapse">
							<ul className="navbar-nav mr-auto">
								...
								<li className='nav-item'>
									<NavLink to="/all-staf" exact className="nav-link" activeClassName="active">Daftar Staf Farmasi</NavLink>
								</li>
							</ul>
						</div>
					</nav>
					...
					<div className="container">
						<Switch>
							...
							<Route path="/add-lab-pasien/:id" exact component={AddLabPasien} />
